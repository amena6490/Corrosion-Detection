...
image_name = 'corrosion_var_6_2'
source_image_dir = './selected_corrosion_images/2/'
destination_dir = './corrosion_concat/'
...
directory_list = [source_image_dir, './Test_masks_jpg/', './predicted_masks_var_6/', './combined_overlays_var_6/']
